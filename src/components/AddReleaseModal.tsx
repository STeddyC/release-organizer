...
function AddReleaseModal({ isOpen, onClose, onSubmit }: AddReleaseModalProps) {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      setRelease(prev => ({ ...prev, artwork: file }));
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className={cn(
          ...
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Add New Release</h2>
            <button
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 mt-6">
              ...
              >
                {isChecking ? 'Checking...' : 'Add Release'}
              </button>
            </div>
          </form>
        </div>
